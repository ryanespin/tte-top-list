...
import { chrisList } from './api/listData/topGbGames/chrisList'
import { ryansList } from './api/listData/topGbGames/ryansList'
import { anthonysList } from './api/listData/topGbGames/anthonysList'



export default function TopGbGames2024() {
  return (
    <>
      <Head>
        <title>Tabletop Express Top List: Top Ghostbusters Games</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <DefaultLayout pageTitle="Top Ghostbusters Games">
        <Flex
          bg="blue.600"
          css={{
            '&::-webkit-scrollbar': {
