...
import { ryansList } from './api/listData/top202026/ryansList'



export default function Top20Ryan2026() {
  ...
  return (
    <>
      ...
      <DefaultLayout
        bgColor="red.600"
        bgImage="./backgroundImages/ryan-shelfie-2026.webp"
        bgPosition="center"
        bgSize="cover"
        ...
        pageTitle={(
          <HStack>
            <Avatar
              name="Ryan Espin"
              src="./personImages/ryan-2026.webp"
            />
            <span>Ryan&apos;s</span>
