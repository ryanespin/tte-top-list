...
import { chrisList } from './api/listData/top10NewToMe2024/chrisList'
import { ryansList } from './api/listData/top10NewToMe2024/ryansList'
import { anthonysList } from './api/listData/top10NewToMe2024/anthonyList'



export default function Top10NewToMe2024() {
  return (
    <>
      <Head>
        <title>Tabletop Express Top List: Top 10 New To Me 2024</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <DefaultLayout pageTitle="Top 10 New To Me 2024">
        <Flex
          bg="blue.600"
          css={{
            '&::-webkit-scrollbar': {
