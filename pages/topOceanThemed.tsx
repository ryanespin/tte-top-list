...
import { chrisList } from './api/listData/topOceanThemed/chrisList'
import { ryansList } from './api/listData/topOceanThemed/ryansList'
import { anthonysList } from './api/listData/topOceanThemed/anthonysList'



export default function TopOceanThemed() {
  return (
    <>
      <Head>
        <title>Tabletop Express Top List: Top Ocean Themed Board Games</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <DefaultLayout pageTitle="Top Ocean Themed Board Games">
        <Flex
          bg="blue.600"
          css={{
            '&::-webkit-scrollbar': {
