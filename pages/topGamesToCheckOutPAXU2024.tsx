...
import { ryansList } from './api/listData/topGamesToCheckOutPAXU2024/ryansList'
import { chrisList } from './api/listData/topGamesToCheckOutPAXU2024/chrisList'
import { anthonysList } from './api/listData/topGamesToCheckOutPAXU2024/anthonyList'

export default function TopGamesToCheckOutPAXU2024() {

  return (
    <>
      <Head>
        <title>Tabletop Express Top List: Top Ten Games You Need To Check Out At PAXU 2024</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <DefaultLayout pageTitle="Top Ten Games You Need To Check Out At PAXU 2024">
        <Flex
          bg="blue.600"
          css={{
            '&::-webkit-scrollbar': {
