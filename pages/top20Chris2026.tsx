...
import { chrisList } from './api/listData/top202026/chrisList'



export default function Top20Chris2026() {
  ...
  return (
    <>
      ...
      <DefaultLayout
        bgColor="blue.600"
        bgImage="./backgroundImages/chris-shelfie-2025.webp"
        bgSize="cover"
        ...
        pageTitle={(
          <HStack>
            <Avatar
              name="Chris Barrows"
              src="./personImages/chris-2025.webp"
            />
            <span>Chris&apos;</span>
