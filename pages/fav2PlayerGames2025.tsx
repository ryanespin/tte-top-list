...
import { chrisList } from './api/listData/fav2Players2025/chrisList'
import { anthonysList } from './api/listData/fav2Players2025/anthonysList'



export default function Fav2Player2025() {
  return (
    <>
      <Head>
        <title>Tabletop Express Top List: Top 10 &quot;Best at 2 Players&quot; Games</title>
      ...
      <Flex flexDirection="column" height="100vh" width="100vw">
        <HStack bg="white" p={4}>
          ...
          <Spacer />
          <Heading>Top 10 &quot;Best at 2 Players&quot; Games</Heading>
        </HStack>
