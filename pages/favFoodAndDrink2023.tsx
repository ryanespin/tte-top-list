...
import { anthonysList } from './api/listData/favFoodAndDrink2023/anthonysList'
import { DefaultLayout } from '@/components/layouts/Default'
import { ryansList } from './api/listData/favFoodAndDrink2023/ryansList'
import { chrisList } from './api/listData/favFoodAndDrink2023/chrisList'

const inter = Inter({ subsets: ['latin'] })

export default function FavFoodAndDrink2023() {
  return (
    <>
      <Head>
        <title>Tabletop Express Top List: Favorite Food and Drink Games</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <DefaultLayout pageTitle="Favorite Food and Drink Games">
        <Flex
          bg="blue.600"
          css={{
            '&::-webkit-scrollbar': {
